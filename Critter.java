...
public abstract class Critter {
    ...
    // This is the default option on whether the critter eats
    public boolean eat() {
        return false;
    }

    // This is the default attack method
    public Attack fight(String opponent) {
        return Attack.FORFEIT;
    }


    // This is the default color for a critter
    public Color getColor() {
        return Color.BLACK;
    }

    // This is the default move for a critter
    public Direction getMove() {
        return Direction.CENTER;
    }

    // This is the default String character for a critter
